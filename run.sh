...
mkdir PccNs-v21_0
cd      PccNs-v21_0
python ../src/gym/stable_solve_2_senders.py --env=PccNs-v21  --model-dir=./final_model/ &> out.out &
cd ../

mkdir PccNs-v22_0
cd      PccNs-v22_0
python ../src/gym/stable_solve_2_senders.py --env=PccNs-v22  --model-dir=./final_model/ &> out.out &
cd ../
